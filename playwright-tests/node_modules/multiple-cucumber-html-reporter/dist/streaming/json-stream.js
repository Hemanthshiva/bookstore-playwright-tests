 ...
 */
export async function* streamFeaturesFromFile(filePath, { keepEmbeddingData }) {
    ...
    const pipelineStages = [fs.createReadStream(filePath), parser({ streamKeys: false })];
    ...
    const pipe = chain(pipelineStages);
 ...
 */
async function writeJsonValueChunks(writeStream, value) {
...
function createStreamedJsonCollectionWriter(filePath, prefix, suffix) {
 ...
 */
export function createJsonArrayFileWriter(filePath) {
 ...
 */
export function createJsonSuiteFileWriter(filePath, envelope) {
