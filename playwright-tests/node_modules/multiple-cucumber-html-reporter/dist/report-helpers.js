 ...
 */
export function enrichMetadata(metadata) {
 ...
 */
export function resolveOptionsMetadata(optionsMetadata, featureUri) {
    if (!optionsMetadata)
        return undefined;
    ...
    const metadataMap = optionsMetadata;
 ...
 * @returns {Step[]}
 */
export function parseFeatureHooks(data, keyword) {
 ...
 */
export function applyMetadataAndHooks(json, options, reportTime) {
 ...
 */
export function enrichStepEmbeddings(step, mediaWriter) {
    ...
    embeddings.forEach((embedding, embeddingIndex) => {
        ...
        const customName = embedding.name ?? embedding.fileName ?? embedding.media?.name ?? embedding.media?.fileName ?? undefined;
        ...
        if (embedding.mime_type === 'application/json' ||
            ...
            const imageSrc = mediaWriter && data
            ...
            const videoSrc = mediaWriter && data
